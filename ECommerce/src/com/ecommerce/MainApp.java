...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		Order order = new Order.Builder("Ram")
				.addItem(ProductFactory.createProduct("clothing", "T-shirt", 20))
				.addItem(ProductFactory.createProduct("books", "Design Patterns", 50))
